...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Senior SRE & DevOps Engineer sustaining 99.9% availability, automating CI/CD, and slashing MTTR by up to 90%." },
      { name: "author", content: "Mriyank Kumar Singh" },
      { property: "og:title", content: "Mriyank Kumar Singh — Senior SRE & DevOps Engineer" },
      { property: "og:description", content: "Sustaining 99.9% availability. Optimizing platforms at scale." },
